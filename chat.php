...
<body>
  ...
  <div id="chatbot-container">
    ...
    <div id="chat-window">
      <?php
      // Renderiza los mensajes de la conversación (por ejemplo, desde la sesión)
      if (isset($_SESSION['conversacion'])) {
  ...
  <script>
    ...
    function resetChat() {
      fetch('index.php?action=reset', { method: 'GET' })
      .then(response => response.json())
      .then(data => {
        if (data.success) {
    ...
    inputField.addEventListener('input', function() {
      ...
      suggestions.forEach(sugg => {
        ...
        // Se añade un icono de corazón junto a la sugerencia
